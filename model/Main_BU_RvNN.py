...
def loadData():
    ...
    for eid in open(testPath):
        ...
        c += 1
    print(str(l1) + " " + str(l2) + " " + str(l3) + " " + str(l4))
    print("train no:" + " " + str(len(tree_train)) + " " + str(len(word_train)) + " " + str(len(index_train)) + " " + str(len(y_train))) 
    print("test no:" + " " + str(len(tree_test)) + " " + str(len(word_test)) + " " + str(len(index_test)) + " " + str(len(y_test)))
    print("dim1 for 0:" + " " + str(len(tree_train[0])) + " " + str(len(word_train[0])) + " " + str(len(index_train[0])))
    print("case 0:" + " " + str(tree_train[0][0]) + " " + str(word_train[0][0]) + " " + str(index_train[0][0]))
    #exit(0)
